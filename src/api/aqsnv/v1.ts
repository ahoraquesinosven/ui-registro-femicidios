...
export enum CaseVictimBondAggressor {
    ...
    EX_PAREJA = "EX_PAREJA",
    FAMILIAR_ABUELA = "FAMILIAR_ABUELA",
    ...
    FAMILIAR_PADRASTRO = "FAMILIAR_PADRASTRO",
    FAMILIAR_MADRASTRA = "FAMILIAR_MADRASTRA",
    CONOCIDO_VECINO = "CONOCIDO_VECINO",
...
export enum CaseAggressorBehaviorPostCase {
    ...
    DETENIDO_EN_EL_LUGAR_DEL_HECHO = "DETENIDO_EN_EL_LUGAR_DEL_HECHO",
