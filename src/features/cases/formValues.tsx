...
export const allAggressorBehaviorsPostCase = Object.values(
  AggressorBehaviorPostCase,
);
...
export const allCaseVictimBondsAggressor = Object.values(
  CaseVictimBondAggressor,
);
...
function victimValuestoVictim(values: typeof defaultFormValues.victim): Victim {
  ...
  return {
    ...
    numberOfChildren: hasChildren
      ? stringToInteger(values.numberOfChildren)
      : undefined,
    ageOfChildren: hasChildren
      ? parseVictimAgeOfChildren(values.ageOfChildren)
      : undefined,
  };
}

function aggressorValuesToAggressor(
  values: typeof defaultFormValues.aggressor,
): Aggressor {
  ...
  return {
    ...
    securityForce: belongsSecurityForce
      ? stringToOptionalEnum(values.securityForce)
      : undefined,
  };
}
...
export function formValuesToCase(values: typeof defaultFormValues): Case {
  ...
  const hasMediaGenderPerspective = yesNoUnknownToBoolean(
    values.hasMediaGenderPerspective,
  );
  ...
  return {
    ...
    isInsufficientDataOrUnderInvestigation:
      values.isInsufficientDataOrUnderInvestigation,
    ...
    judicialMeasures: wasJudicialized
      ? stringArrayToEnumArray(values.judicialMeasures)
      : undefined,
    ...
    coverageMediaPerspectiveNotes:
      hasMediaGenderPerspective !== undefined
        ? values.coverageMediaPerspectiveNotes
        : undefined,
  };
}
...
function aggressorToAggressorValues(
  value: Aggressor,
): typeof defaultFormValues.aggressor {
  return {
    fullName: value.fullName || "",
...
export function caseToFormValues(value: Case): typeof defaultFormValues {
  return {
    ...
    isInsufficientDataOrUnderInvestigation:
      value.isInsufficientDataOrUnderInvestigation || false,
    ...
    hasMediaGenderPerspective: booleanToYesNoUnknown(
      value.hasMediaGenderPerspective,
    ),
